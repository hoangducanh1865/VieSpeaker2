...
from face_pipeline_for_combination import ASVDataPipeline, ORIGINAL_FACE_SETUP
...
def main():
	...
	parser.add_argument("--video_path", default='data/diarization_test_set/video/interview_noise.mp4')
	parser.add_argument("--sd_diarization", default='pipeline/audio_pipeline/testing/test_diarization_output_precision-2/interview_noise.txt',
						help="Speaker diarization output from SD model (e.g. sample_0.txt)")
	...
	parser.add_argument("--audio_visual_model", choices=["lr_asd", "loconet"], default="lr_asd",
	...
	parser.add_argument("--lrasd_model", default="audio_visual_model/LR-ASD/weight/finetuning_TalkSet.model",
					help="Path to LR-ASD model (used only when --audio_visual_model lr_asd)")
	parser.add_argument("--loconet_root", default="audio_visual_model/LoCoNet_ASD",
					help="Path to LoCoNet root directory")

	# Face pipeline setup
	parser.add_argument("--out_dir", default="results_supplement")
