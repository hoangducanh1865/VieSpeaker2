...
class ASD(nn.Module):
    def __init__(self, lr = 0.001, lrDecay = 0.95, use_cuda=True, **kwargs):
        super(ASD, self).__init__()
        # Check CUDA availability - fallback to CPU if unavailable
    ...
    def loadParameters(self, path):
        ...
        # Load on the correct device (CPU or CUDA)
