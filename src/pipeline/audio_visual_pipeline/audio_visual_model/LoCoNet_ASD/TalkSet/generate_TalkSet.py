...
parser.add_argument('--Vox_audio',   type=str, default= 'data/VoxCeleb2/audio/audio_clean/clean/train')
parser.add_argument('--Vox_video',   type=str, default= 'data/VoxCeleb2/video/orig/train')
