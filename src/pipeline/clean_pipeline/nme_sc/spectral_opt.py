...
_SC_UTILS_DIR = os.path.join(_NME_SC_DIR, "sc_utils")
for _p in [_NME_SC_DIR, _SC_UTILS_DIR]:
...
# Original standalone CLI entry point. Guarded so that `import spectral_opt`
# (done by run_nme_sc.py to reuse the classes) does not hijack the caller's argv.
